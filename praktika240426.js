...
const nameAktoriaus = 'Jonas';
const surnameAktoriaus = 'Jonaitis';

if (nameAktoriaus.length > surnameAktoriaus.length) {
    console.log(nameAktoriaus);
} else {
    console.log(surnameAktoriaus);
}
...
const nameJono = 'Jonas';
const surnameJono = 'Jonaitis';
const bornDate = 1981;
const nowDate = 2024;
